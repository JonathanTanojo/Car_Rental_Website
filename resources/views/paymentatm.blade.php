                    ...
                    <div class="bgbiru">
                        <div class="list-group">
                            <form action="{{ url('payment/bank/'.$i->K_ID) }}" method="POST">
                                @csrf
                                <input type="submit" class="list-group-item list-group-item-action " value="Bank Transfer">
                            </form>
                            <form action="{{ url('payment/atm/'.$i->K_ID) }}" method="POST">
                                @csrf
                                <input type="submit" class="list-group-item list-group-item-action active" value="ATM">
                            </form>
                          </div>
                    </div>
                </div>
